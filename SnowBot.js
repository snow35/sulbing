...
const Icelist = new Discord.MessageEmbed()
	...
	.addFields(
		//{ name: '빙수이름 : 가격(원)', value1: '인절미설밍 : 7,900원', value2: '오레오초코몬스터설빙(오레오설빙) : 11,900원', value3: '와르르생딸기설빙(기간한정!) : 11,500원', value4: '민트초코설빙 : 10,900원', value5: '티라미수설빙 : 10,900', value6: '애플망고치즈설빙 : 11,900원'},
		{
			title : "빙수이름 : 가격(원)",
