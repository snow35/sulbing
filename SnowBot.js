...
const HighCardRules = new Discord.MessageEmbed()
	...
	.addFields(
		{ name: '<:R_A:800482738578260009> 양측 플레이어는 카드를 한장씩 뽑게 됩니다', value: 'ㅤㅤ자신의 카드는 볼 수 없으며 상대방의 카드만 볼 수 있습니다\nㅤㅤ상대방의 카드는 DM으로 전송됩니다\n​'},
		{ name: '<:R_2:800482753022787626> 자신의 차례에 자신의 카드가 상대방의 카드보다\n	   더 크다고 생각하시면 코인을 배팅합니다', value:'ㅤㅤ**!(숫자)** : 처음 제시할때 사용합니다\nㅤㅤ**!콜** : 상대방이 지불한 양과 같은 양의 코인을 지불합니다\nㅤㅤ**!더블** : 상대방이 지불한 양의 2배를 지불합니다.\nㅤㅤ**!따당** : 상대방이 지불한 양의 4배를 지불합니다\nㅤㅤ**!다이** : 자신이 질것 같다고 생각되는경우 라운드를 종료하고 상대방이 승리합니다\n​'},
		{ name: '<:R_3:800482766151221268> 각각 3번의 배팅후에 결과가 공개되며\n	   더 큰 숫자를 가진 사람이 배팅한 코인을 전부 가져갑니다', value:'​'},
		{ name: '<:R_4:800482778344980541> 카드의 족보는 다음과 같습니다', value: "ㅤㅤ<:B_2:800474788907712542> <:B_3:800476373159641148> <:B_4:800476384426197022> <:B_5:800476396484427816> <:B_6:800476410698530826> <:B_7:800476417993080841> <:B_8:800476428209487882> <:B_9:800476440927010836> <:B_10:800478017860141058> <:B_J:800478030149320775> <:B_Q:800478046259642378> <:B_K:800478059924160542> <:B_A:800474199792681000>"},
		{ name: '<:R_5:800482789597249566> 카드의 숫자가 같은 경우 모양에 따라 결정됩니다', value: "ㅤㅤ<:Spade:800032748625592340> <:Diamond:800032787876937799> <:Heart:800032761867927562> <:Club:800032775759200376>"}
	);
