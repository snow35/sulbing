...
const Icelist = new Discord.MessageEmbed()
	...
	.addFields(
		{ name: '빙수이름 : 가격(원)', value: '인절미설밍 : 7,900원', value: '오레오초코몬스터설빙(오레오설빙) : 11,900원', value: '와르르생딸기설빙(기간한정!) : 11,500원', value: '민트초코설빙 : 10,900원', value: '티라미수설빙 : 10,900', value: '애플망고치즈설빙 : 11,900원'},
